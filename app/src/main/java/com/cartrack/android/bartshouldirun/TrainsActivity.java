...
//        trains.add(new Train("Richmond", "4 MIN", Color.RED));
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train("Dublin", "5 MIN", Color.BLUE));
//        trains.add(new Train("Fremont", "5 MIN", Color.GREEN));
//        trains.add(new Train());
//        trains.add(new Train("Fremont", "5 MIN", Color.rgb(255,117,53)));
//        trains.add(new Train("Richmond", "4 MIN", Color.RED));
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
...
//        trains.add(new Train());
//        trains.add(new Train("Fremont", "5 MIN", Color.rgb(255,117,53)));
//        trains.add(new Train("Millbrae", "5 MIN", Color.YELLOW));
//        trains.add(new Train());
//        trains.add(new Train("SFO Int'l", "5 MIN", Color.RED));
//        trains.add(new Train());
//        trains.add(new Train("Millbrae", "5 MIN", Color.YELLOW));
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train("SFO Int'l", "5 MIN", Color.RED));
//        trains.add(new Train());
//        trains.add(new Train("Richmond", "5 MIN", Color.RED));
//        trains.add(new Train("Fremont", "5 MIN", Color.rgb(255,117,53)));
//        trains.add(new Train());
//        trains.add(new Train("Pittsburg", "5 MIN", Color.YELLOW));
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
...
//        trains.add(new Train());
//        trains.add(new Train("Fremont", "5 MIN", Color.GREEN));
//        trains.add(new Train());trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train());
...
//        trains.add(new Train("Fremont", "5 MIN", Color.GREEN));
//        trains.add(new Train("Pittsburg", "5 MIN", Color.YELLOW));
//        trains.add(new Train("Fremont", "5 MIN", Color.GREEN));        trains.add(new Train());
//        trains.add(new Train("SFO Int'l", "5 MIN", Color.RED));trains.add(new Train());
//        trains.add(new Train());
//        trains.add(new Train("Richmond", "5 MIN", Color.RED));
//        trains.add(new Train("Fremont", "5 MIN", Color.GREEN));
//        trains.add(new Train("Pittsburg", "5 MIN", Color.YELLOW));
...
//        trains.add(new Train("Dublin", "5 MIN", Color.BLUE));
    ...
    private ArrayList<SamiItem> createSamiItems(ArrayList<Train> allTrains, String platform){
        ...
        while(allTrains.size() > 0) {
            ...
            if(!aTrainAdded){
                result.add(new SamiItem(new Train(),null,""));
            }
            index++;
        }
        return result;
    ...
    private void refreshPageWithStationData(Station station){
        ...
        theSamiView.initSamiView(createSamiItems((ArrayList<Train>)station.Trains.clone(),"1"), 0.5f);
        theSamiView2.initSamiView(createSamiItems((ArrayList<Train>)station.Trains.clone(),"2"), 0.5f);
